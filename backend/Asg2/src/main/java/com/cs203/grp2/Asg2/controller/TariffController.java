...
public class TariffController {
    ...
    // Example: GET
    // /wits/tariff?importer=BGR&exporter=CHN&hs6=271012&date=2025-10-14
    @GetMapping("/tariff")
    ...
    @PostMapping("/mfnrate")
    public void addMfnRate(@RequestBody AddMfnRateDTO dto) throws Exception {
        witsService.addMfnRate(dto);
    }

    @GetMapping("/mfnrates")
    public List<MfnRateDTO> getAllMfnRates() throws Exception {
        return witsService.getAllMfnRates();
    }
}