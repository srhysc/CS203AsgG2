...
public class RefineryResponseDTO {
    ...
    private List<RefineryCostResponseDTO> estimatedCosts;
    ...
    public RefineryResponseDTO(String name, String company, String location, Integer operationalFrom,
            Integer operationalTo, boolean canRefineAny, List<RefineryCostResponseDTO> estimatedCosts,
    ...
    public List<RefineryCostResponseDTO> getEstimatedCosts() {
        return estimatedCosts;
    }

    public void setEstimatedCosts(List<RefineryCostResponseDTO> estimatedCosts) {
        this.estimatedCosts = estimatedCosts;
    }
