...
System.out.println("ADDING BOOKMARK: " + bookmarkName + "IMPORTER: " + response.getImportingCountry() + "EXPORTER: " + response.getExportingCountry() + response.getPricePerUnit() + response.getTotalLandedCost()); 
