...
public class ShippingFeeResponseDTO {
    ...
    public List<ShippingFeeEntryResponseDTO> getShippingFees() {
        return shippingFees;
    }
    public void setShippingFees(List<ShippingFeeEntryResponseDTO> shippingFees) {
        this.shippingFees = shippingFees;
    }
    private String country2Iso3;
    private String country1IsoNumeric;
    private String country2IsoNumeric;
    private List<ShippingFeeEntryResponseDTO> shippingFees;
