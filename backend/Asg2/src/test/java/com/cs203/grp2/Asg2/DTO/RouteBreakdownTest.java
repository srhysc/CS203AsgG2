...
class RouteBreakdownTest {
    ...
    void testConstructorWithHighTariffAndVat() {
        ...
        RouteBreakdown breakdown = new RouteBreakdown(
            "CHN", "SGP", "AUS",
            5000.0, 2500.0, 1000.0, 8500.0, 0.10
        );
    ...
    void testGettersReturnCorrectValues() {
        ...
        RouteBreakdown breakdown = new RouteBreakdown(
            "DEU", "FRA", "GBR",
            2000.0, 300.0, 120.0, 2420.0, 0.06
        );
    ...
    void testCostCalculationLogic() {
        ...
        RouteBreakdown breakdown = new RouteBreakdown(
            "USA", "MEX", "CAN",
            baseCost, tariffFees, vatFees, expectedTotal, 0.05
        );
