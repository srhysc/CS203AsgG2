...
class RouteOptimizationResponseTest {
    ...
    void testConstructorWithMultipleRoutes() {
        ...
        List<RouteBreakdown> routes = Arrays.asList(
            new RouteBreakdown("USA", "MEX", "CAN", 1000.0, 150.0, 75.0, 1225.0, 0.05, "Crude Oil", 0.0),
            new RouteBreakdown("USA", null, "CAN", 1000.0, 100.0, 50.0, 1150.0, 0.05, "Crude Oil", 0.0),
            new RouteBreakdown("USA", "PAN", "CAN", 1000.0, 200.0, 100.0, 1300.0, 0.05, "Crude Oil", 0.0)
        );
    ...
    void testGetTopRoutes() {
        // Arrange
        RouteBreakdown route1 = new RouteBreakdown("USA", "MEX", "CAN", 1000.0, 150.0, 75.0, 1225.0, 0.05, "Crude Oil", 0.0);
        RouteBreakdown route2 = new RouteBreakdown("USA", null, "CAN", 1000.0, 100.0, 50.0, 1150.0, 0.05, "Crude Oil", 0.0);
    ...
    void testRoutesSortedByCost() {
        ...
        RouteBreakdown cheapestRoute = new RouteBreakdown("USA", null, "CAN", 1000.0, 100.0, 50.0, 1150.0, 0.05, "Crude Oil", 0.0);
        RouteBreakdown midRoute = new RouteBreakdown("USA", "MEX", "CAN", 1000.0, 150.0, 75.0, 1225.0, 0.05, "Crude Oil", 0.0);
        RouteBreakdown expensiveRoute = new RouteBreakdown("USA", "PAN", "CAN", 1000.0, 200.0, 100.0, 1300.0, 0.05, "Crude Oil", 0.0);
    ...
    void testHighPetroleumPrice() {
        // Arrange
        List<RouteBreakdown> routes = Arrays.asList(
            new RouteBreakdown("SAU", "ARE", "CHN", 5000.0, 500.0, 250.0, 5750.0, 0.05, "Crude Oil", 0.0)
        );
    ...
    void testResponseImmutability() {
        ...
        routes.add(new RouteBreakdown("USA", "MEX", "CAN", 1000.0, 150.0, 75.0, 1225.0, 0.05, "Crude Oil", 0.0));
    ...
    void testMultipleRoutesWithDifferentTransitPoints() {
        // Arrange
        List<RouteBreakdown> routes = Arrays.asList(
            new RouteBreakdown("CHN", null, "USA", 2000.0, 200.0, 100.0, 2300.0, 0.05, "Crude Oil", 0.0),
            new RouteBreakdown("CHN", "SGP", "USA", 2000.0, 180.0, 90.0, 2270.0, 0.05, "Crude Oil", 0.0),
            new RouteBreakdown("CHN", "JPN", "USA", 2000.0, 220.0, 110.0, 2330.0, 0.05, "Crude Oil", 0.0)
        );
