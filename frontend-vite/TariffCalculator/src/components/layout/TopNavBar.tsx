...
const navItems: NavItem[] = [
  ...
  { id: "calculator", label: "Tariff Calculator", url: "/calculator", icon: Calculator },
  { id: "tariffs", label: "View Tariffs", url: "/lookup", icon: Search },
  { id: "country", label: "Country Info", url: "/country", icon: Globe },
  { id: "petroleum", label: "Petroleum Details", url: "/petroleum", icon: Droplet },
  { id: "refineries", label: "Refineries", url: "/refineries", icon: Factory },
  { id: "shipping", label: "Shipping Cost", url: "/shipping", icon: Ship },
  { id: "route", label: "Refinery Route", url: "/route", icon: Map },
  { id: "admin", label: "Administrator", url: "/administrator", icon: Shield, requiresAdmin: true },
];
...
export function TopNavBar({ activeTab, setActiveTab }: TopNavBarProps) {
  const isAdmin = true; // Replace with dynamic logic
          ...
          <UserButton
            appearance={{
              elements: {
                userButtonAvatarBox: "w-10 h-10",
                userButtonRoot:
                  "bg-gray-700 hover:bg-gray-600 text-white rounded-md p-2",
              },
            }}
          />
        </SignedIn>
